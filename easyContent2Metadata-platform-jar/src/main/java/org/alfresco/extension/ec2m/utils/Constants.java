...
public class Constants {
    ...
    public static final String EXTRACTOR_MAPPING_MODEL = "http://www.mimacom.com/alfresco/easyContent2Metadata/1.0";
    ...
    public static final QName ASPECT_ACTIVE      = QName.createQName(EXTRACTOR_MAPPING_MODEL, "item_active");
}
